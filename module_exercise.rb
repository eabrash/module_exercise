...
# Provides a container to hold things like methods, classes and constants as a way to group them together logically
# and to help avoid conflicts with other methods and classes that may have the same name,
...
###################################
  ...
  # p our_array.length
  #
  # p Perimeter::AWESOME_PERIMETER
  #
  # bestpuppy = Perimeter::Puppy.new("Bosco", "terrier", "6")
  #
  # p bestpuppy.to_s
  #
  # p Perimeter::Puppy::AGE_IT_CAN_GO_HOME
...
#
#   location = Traveller.new("Kirkland, WA 98033")
#
#   user1 = Travel::Traveller.new({name: "Satine the Cat", email: "satinemarine@kittymail.com", location: location})
#
#   puts user1.location.city
  ...
  # Outside the class or module, they may be accessed using the scope operator, :: prefixed by an
  # expression that returns the appropriate class or module.
  ...
  # Constants may be added to existing classes and modules from the outside by using the class or module name
  # and the scope operator before the constant name.
      ...
      puts "Blackjack::Player::Player::MAX_Players - #{Blackjack::Player::Player::MAX_PLAYERS}"
